...
const translations = {
  es: {
    ...
    reviews: {
      tag: 'Opiniones',
      title: 'Comentarios de los huéspedes',
      description:
        'Una síntesis de las reseñas mejor valoradas de Booking y Google para entender rápido cómo se vive la experiencia en Casa Müller.',
      ...
      goTo: 'Ir a la reseña',
      basedOn: 'Basado en opiniones reales',
      categoriesLabel: 'Categorías',
      topicsLabel: 'Temas destacados',
      filterLabel: 'Reseñas destacadas',
      reviewCount: '11 comentarios',
      categories: [
        { label: 'Atención', value: '10' },
        { label: 'Limpieza', value: '10' },
        { label: 'Comodidad', value: '9.8' },
        { label: 'Ubicación', value: '9.5' },
        { label: 'Equipamiento', value: '9.7' },
        { label: 'Privacidad', value: '9.9' },
      ],
      topics: ['Camas', 'Privado', 'Ubicación', 'Tranquilidad', 'Parrilla'],
      summary: {
        rating: '9.6',
        caption: 'Puntaje general combinado entre estadía, atención, confort y experiencia en el entorno.',
    ...
    contact: {
      ...
      description: 'Escribinos por WhatsApp, Instagram o dejá tu consulta con las fechas que tenés en mente.',
      instagramButton: 'Instagram',
      whatsappButton: 'WhatsApp',
      submit: 'Enviar consulta por WhatsApp',
      placeholders: '',
      whatsappNumber: '542614704047',
      whatsappTemplate: {
  ...
  en: {
    ...
    reviews: {
      ...
      title: 'Guest reviews',
      description:
        'A fast overview of top-rated Booking and Google feedback to understand the Casa Müller experience at a glance.',
      bookingLabel: 'Booking',
      googleLabel: 'Google Reviews',
      ...
      next: 'Next review',
      goTo: 'Go to review',
      basedOn: 'Based on real guest reviews',
      categoriesLabel: 'Categories',
      topicsLabel: 'Highlighted topics',
      filterLabel: 'Featured reviews',
      reviewCount: '11 reviews',
      categories: [
        { label: 'Staff', value: '10' },
        { label: 'Cleanliness', value: '10' },
        { label: 'Comfort', value: '9.8' },
        { label: 'Location', value: '9.5' },
        { label: 'Amenities', value: '9.7' },
        { label: 'Privacy', value: '9.9' },
      ],
      topics: ['Beds', 'Private', 'Location', 'Quiet', 'Grill'],
      summary: {
        rating: '9.6',
        caption: 'Overall score combining stay quality, hospitality, comfort, and the surrounding experience.',
    ...
    contact: {
      ...
      description: 'Write to us on WhatsApp, Instagram, or send your request with your preferred dates.',
      instagramButton: 'Instagram',
      whatsappButton: 'WhatsApp',
  ...
  pt: {
    ...
    reviews: {
      tag: 'Opiniões',
      title: 'Comentários dos hóspedes',
      description:
        'Uma visão rápida das melhores avaliações do Booking e do Google para entender a experiência na Casa Müller.',
      bookingLabel: 'Booking',
      googleLabel: 'Google Reviews',
      ...
      basedOn: 'Baseado em avaliações reais',
      categoriesLabel: 'Categorias',
      topicsLabel: 'Temas em destaque',
      filterLabel: 'Avaliações em destaque',
      reviewCount: '11 avaliações',
      categories: [
        { label: 'Atendimento', value: '10' },
        { label: 'Limpeza', value: '10' },
        { label: 'Conforto', value: '9.8' },
        { label: 'Localização', value: '9.5' },
        { label: 'Estrutura', value: '9.7' },
        { label: 'Privacidade', value: '9.9' },
      ],
      topics: ['Camas', 'Privado', 'Localização', 'Tranquilidade', 'Churrasqueira'],
      summary: {
        rating: '9.6',
        caption: 'Nota geral combinando estadia, hospitalidade, conforto e experiência no entorno.',
    ...
    contact: {
      ...
      description: 'Fale conosco pelo WhatsApp, Instagram ou envie sua consulta com as datas que está planejando.',
      instagramButton: 'Instagram',
      whatsappButton: 'WhatsApp',
